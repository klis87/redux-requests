module.exports = {
  docs: {
    ...
    'API reference': [
      ...
      'api-reference/subscription-action',
      ...
      'api-reference/get-websocket-state',
      'api-reference/reset-requests',
      'api-reference/abort-requests',
      'api-reference/clear-requests-cache',
      'api-reference/stop-polling',
      'api-reference/stop-subscriptions',
      'api-reference/open-websocket',
      'api-reference/close-websocket',
